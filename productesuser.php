<?php
    ...
    if(($_POST['texto'])){
        $filename="/var/www/html/Projecte/prestec";
...
<head>
	...
	<body>
        ...
        <?php
               $fitxer_llibres="/var/www/html/Projecte/llibres";
        ...
        <div class="usuaricuadre">
			<form action="http://localhost/Projecte/logoutuser.php" method="POST">
        ...
        <div class="usuaricuadreprestec">
            ...
            <?php
                $fitxer_prestec="/var/www/html/Projecte/prestec";
